...
<html lang="en">
  ...
  <div class="d-flex flex-column flex-md-row align-items-start mb-2">
    <input type="text" class="form-control me-2 w-md-full" id="name2" placeholder="Passenger Name" style="max-width: 220px" />
    <div class="d-flex">
    <select class="form-select me-2 country-code-select" id="code2" style="max-width: 120px">
      <option selected>+91</option>
      <option>+1</option>
      <option>+44</option>
    </select>
    <input type="number" class="form-control w-md-full" id="phone2" maxlength="10" oninput="if(this.value.length > 10) this.value = this.value.slice(0, 10)" placeholder="Phone number" style="max-width: 200px" />
    </div>
  </div>


  <div class="d-flex align-items-start mb-2 flex-column flex-md-row">
    <input type="text" class="form-control me-2 w-md-full" id="name3" placeholder="Passenger Name" style="max-width: 220px" />
    <div class="d-flex">
    <select class="form-select me-2 country-code-select" id="code3" style="max-width: 120px">
      <option selected>+91</option>
      <option>+1</option>
      <option>+44</option>
    </select>
    <input type="number" class="form-control w-md-full" id="phone3" maxlength="10" oninput="if(this.value.length > 10) this.value = this.value.slice(0, 10)" placeholder="Phone number" style="max-width: 200px" />
    </div>
  </div>

  <div class="d-flex align-items-start mb-2 flex-column flex-md-row">
    <input type="text" class="form-control me-2 w-md-full" id="name4" placeholder="Passenger Name" style="max-width: 220px" />
    <div class="d-flex">
    <select class="form-select me-2 country-code-select" id="code4" style="max-width: 120px">
      <option selected>+91</option>
      <option>+1</option>
      <option>+44</option>
    </select>
    <input type="number" class="form-control w-md-full" id="phone4" maxlength="10" oninput="if(this.value.length > 10) this.value = this.value.slice(0, 10)" placeholder="Phone number" style="max-width: 200px" />
    </div>
  </div>

  <div class="d-flex align-items-start mb-2 flex-column flex-md-row">
    <input type="text" class="form-control me-2 w-md-full" id="name5" placeholder="Passenger Name" style="max-width: 220px" />
    <div class="d-flex">
    <select class="form-select me-2 country-code-select" id="code5" style="max-width: 120px">
      <option selected>+91</option>
      <option>+1</option>
      <option>+44</option>
    </select>
    <input type="number" class="form-control w-md-full" id="phone5" maxlength="10" oninput="if(this.value.length > 10) this.value = this.value.slice(0, 10)" placeholder="Phone number" style="max-width: 200px" />
    </div>
  </div>
  <input
              type="email"
            ...
            <div style="display: flex; justify-content: space-between">
              ...
              <div>
                ...
                <select class="form-select" id="dropTerminal">
                  <option disabled selected>Choose Drop Terminal</option>
...
<!-- footer <nav></nav> -->
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    bookingForm.addEventListener("submit", async function (e) {
      ...
      payBtn.innerHTML = `
        <div style="display: inline-flex; align-items: center;">
          ...
          Booking your ticket... Please wait! ⚠️ Do not refresh the page.
        </div>`;
      ...
      let price = 0;
      if (serviceType === "Shuttle") price = 10 * names.length;
      else if (serviceType === "Sedan") {
      ...
      try {
        ...
        console.log("✅ bookingDetails saved to localStorage.");
      } catch (err) {
      ...
      // Send to backend
      try {
        const res = await fetch("https://emailsending-gtg.onrender.com/api/book", {
          method: "POST",
        ...
        if (!res.ok) {
          alert("❌ Server error while booking. Please try again.");
          payBtn.disabled = false;
          payBtn.innerText = "Book Now";
          return;
        }
    ...
    // Dummy updateCheckoutSummary if needed
    function updateCheckoutSummary() {
      // you can update fare summary here if needed
    }
  });
